...
pub struct RenderSettings {
    ...
    pub saturation: RangeSetting,
    pub contrast: RangeSetting,
    pub offset_r: RangeSetting,
    pub offset_g: RangeSetting,
    pub offset_b: RangeSetting,
    pub gamma_r: RangeSetting,
    pub gamma_g: RangeSetting,
    pub gamma_b: RangeSetting,
    pub gain_r: RangeSetting,
    pub gain_g: RangeSetting,
    pub gain_b: RangeSetting,
    pub hdr: SwitchSetting,
    pub paper_white: RangeSetting,
    pub hdr_peak: RangeSetting,
...
impl Default for RenderSettings {
    fn default() -> Self {
        Self {
            ...
            saturation: RangeSetting::new(
                1.0,
                0.0,
                2.0,
                "Saturation",
                "Color saturation around luminance, applied before tonemapping (1 keeps colors unchanged).",
            ),
            contrast: RangeSetting::new(
                1.0,
                0.5,
                2.0,
                "Contrast",
                "Contrast around middle grey, applied before tonemapping (1 keeps the image unchanged).",
            ),
            offset_r: RangeSetting::new(
                0.0,
                -0.1,
                0.1,
                "OffsetR",
                "Offset added to red, most visible in shadows (0 keeps the image unchanged).",
            ),
            offset_g: RangeSetting::new(
                0.0,
                -0.1,
                0.1,
                "OffsetG",
                "Offset added to green, most visible in shadows (0 keeps the image unchanged).",
            ),
            offset_b: RangeSetting::new(
                0.0,
                -0.1,
                0.1,
                "OffsetB",
                "Offset added to blue, most visible in shadows (0 keeps the image unchanged).",
            ),
            gamma_r: RangeSetting::new(
                1.0,
                0.5,
                2.0,
                "Gamma R",
                "Red midtones: above 1 brightens, below 1 darkens (1 keeps the image unchanged).",
            ),
            gamma_g: RangeSetting::new(
                1.0,
                0.5,
                2.0,
                "Gamma G",
                "Green midtones: above 1 brightens, below 1 darkens (1 keeps the image unchanged).",
            ),
            gamma_b: RangeSetting::new(
                1.0,
                0.5,
                2.0,
                "Gamma B",
                "Blue midtones: above 1 brightens, below 1 darkens (1 keeps the image unchanged).",
            ),
            gain_r: RangeSetting::new(
                1.0,
                0.0,
                2.0,
                "Gain R",
                "Multiplier for red, most visible in highlights (1 keeps the image unchanged).",
            ),
            gain_g: RangeSetting::new(
                1.0,
                0.0,
                2.0,
                "Gain G",
                "Multiplier for green, most visible in highlights (1 keeps the image unchanged).",
            ),
            gain_b: RangeSetting::new(
                1.0,
                0.0,
                2.0,
                "Gain B",
                "Multiplier for blue, most visible in highlights (1 keeps the image unchanged).",
            ),
            ...
            hdr_peak: RangeSetting::new(
                12.5,
                1.0,
                20.0,
                "HDR peak",
                "Peak brightness of the HDR display, in units of scRGB white (1.0 = 80 nits).",
            ),
