...
pub struct DescriptorIndexManagers {
    ...
    pub primitive_index_manager: Arc<DescriptorIndexManager>,
...
impl DescriptorIndexManagers {
    pub fn create(
        ...
        let primitive_index_manager = DescriptorIndexManager::new(4096, frames_in_flight);
        ...
        Self {
            ...
            primitive_index_manager: Arc::new(primitive_index_manager),
