use crate::resource::common::resource_provider::ResourceProvider;
use crate::resource::index::resource_index::ResourceIndex;
use crate::resource::resource_io::ResourceIO;
use crate::resource::shader::shader_backend::ShaderBackend;
use crate::resource::shader::shader_config::ShaderConfig;
use ash::Device;
use std::sync::Arc;
...
impl ResourceHub {
    pub fn new(device: Arc<Device>) -> Self {
        let resource_io = Arc::new(ResourceIO::new());

        let resource_index = Arc::new(ResourceIndex::new(resource_io.clone()));

        let shader_provider =
            ResourceProvider::from(ShaderBackend::new(device, resource_io, resource_index));
