use crate::resource::common::resource_backend::{ResourceBackend, ResourceKey};
...
impl ResourceBackend for ShaderBackend {
    ...
    fn collect_dependencies(
        ...
        let shader_data = self.resource_io.read(&shader_index_entry.file_path);

        Self::Dependencies {
            spv_src: shader_data.as_slice().into(),
        }
    }
