...
use crate::ui_resource_manager::UiResourceManager;
use statistics::UiStatistics;
...
impl UiContext {
    ...
    pub fn render_ui(
        ...
        self.ui_renderer.render(&self, input, settings_handler, statistics, picked_entity);
